    ...
    <section className="relative py-24 bg-background overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white">Leadership Team</h2>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {leaders.map((member) => (
            <motion.div
              ...
              className={`group relative overflow-hidden rounded-[30px] border border-white/10 p-8 bg-slate-950/80 shadow-[0_25px_80px_rgba(15,23,42,0.35)] backdrop-blur-xl transition-all duration-500 ${member.highlight ? "scale-[1.03] border-purple-400/40 shadow-[0_0_80px_rgba(124,58,237,0.22)]" : "hover:border-blue-400/30 hover:shadow-[0_0_40px_rgba(59,130,246,0.18)]"}`}
            >
              ...
              <div className="relative flex flex-col items-center text-center gap-6">
                <div className={`relative flex h-32 w-32 items-center justify-center rounded-full border-2 ${member.highlight ? "border-purple-500" : "border-blue-500/50"} bg-slate-950/90 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.06)]`}>
                  <img
                    src={member.image}
                    alt={member.name}
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm uppercase tracking-[0.2em] text-purple-300/70">{member.role}</p>
